...
// Good news: wrapper function is generated from .h file
// Bad news: it does not automatically take care of either the argument or the return value
// Need to code an R-interface.
